...
(function (global, factory) {
  ...
  function getOverflowParent(node, type) {
    if (type === void 0) {
      type = 'scroll';
    }
  ...
  function listOverflowParents(element, type, list) {
    if (type === void 0) {
      type = 'scroll';
    }
    ...
    return function createPopper(reference, popper, options) {
      ...
      var instance = {
        ...
        setOptions: function setOptions(options) {
          ...
          {
            var modifiers = uniqueBy([].concat(state.orderedModifiers, state.options.modifiers), function (_ref3) {
              var name = _ref3.name;
              return name;
            });
            ...
            if (state.options.placement.includes('auto')) {
              var flipModifier = state.orderedModifiers.find(function (_ref4) {
                var name = _ref4.name;
                return name === 'flip';
              });
      ...
      instance.setOptions(options); // Modifiers have the ability to execute arbitrary code before the first
  ...
  function listClippingParents(element) {
  ...
  function flip(_ref) {
    ...
    var placements = uniqueBy([preferredPlacement].concat(fallbackPlacements).reduce(function (acc, placement) {
      return placement.includes('auto') ? acc.concat(computeAutoPlacement(state, {
        placement: placement,
        boundary: boundary,
        rootBoundary: rootBoundary,
        padding: padding,
    ...
    var placementOverflowData = placements.reduce(function (acc, placement) {
      var basePlacement = getBasePlacement(placement);
      var isStartVariation = placement.includes(start);
  ...
  function preventOverflow(_ref) {
    ...
    if (checkMainAxis) {
      ...
      var tetherMin = state.modifiersData.popperOffsets[mainAxis] + minOffset;
      var tetherMax = state.modifiersData.popperOffsets[mainAxis] + maxOffset;
